...
public class CliBackendParityTests
{
    ...
    private sealed class ParityBackendContext : IAsyncDisposable
    {
        ...
        {
            string musicRoot = CreateTempDir("sldl-cli-parity-local-music-");
            string outputDir = CreateTempDir("sldl-cli-parity-local-out-");
            seedMusic(musicRoot);
        ...
        {
            string musicRoot = CreateTempDir("sldl-cli-parity-remote-music-");
            string outputDir = CreateTempDir("sldl-cli-parity-remote-out-");
            seedMusic(musicRoot);
